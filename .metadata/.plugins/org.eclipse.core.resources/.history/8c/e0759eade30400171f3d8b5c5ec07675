...
public class Decode {
  ...
  static void decodeInput() {
    ...
    String[] languages = {"danish","english","finnish","french","german","polish","russian","spanish","swedish"};
  ...
  static void printMessage() {
    for(int i = 0; i < inputs.length; i++) System.out.println(inputs[i].substring(0,inputs[i].length()-1));
  }
